          ...
          "Actions": [
            {
              ...
              "function": {
                ...
                "parameters": [
                  {
                    "ParamType": 5,
                    "value": "if(GetLocalPlayer() == GetEnumPlayer()) then"
                  }
                ],
    ...
    },
    {
      ...
      "function": {
        ...
        "parameters": [
          ...
          {
            "ParamType": 5,
            "value": "Effects\\ExplosionBIG.mdx"
          }
        ],
