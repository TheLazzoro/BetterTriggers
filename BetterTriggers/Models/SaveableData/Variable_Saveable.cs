...
namespace BetterTriggers.Models.SaveableData
{
    public class Variable_Saveable : IReferable_Saveable
    {
        ...
        public Parameter_Saveable InitialValue { get { return _initialValue; } set { _initialValue = value; OnValuesChanged(); } }
        ...
        [JsonIgnore]
        private Parameter_Saveable _initialValue;
        [JsonIgnore]
        ...
        public Variable_Saveable Clone()
        {
            Variable_Saveable cloned = new Variable_Saveable();
            cloned.Id = Id;
